...
const Navbar = () => {
  return (
    <div className="flex flex-row justify-between items-center px-8 py-8">
      <div className="flex flex-row items-center gap-2">
      <motion.span
      className="text-2xl dark:text-sky-100"
           initial={{ opacity: 0 }}
           animate={{ opacity: 1 }}
      ...
      >
        <h1 className="text-2xl dark:text-sky-100">Ethan</h1>
      </motion.div>
      ...
      <div className="flex flex-row items-center gap-3">
        ...
        >
          <Link className="text-gray-500 transition-all duration-500 hover:text-slate-900 dark:hover:text-slate-100" href="#contact">
